...
<html>
    <head>
        ...
        <!-- jvectormap -->
        <link href="/css/plugins/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- fullCalendar -->
        <link href="/css/plugins/fullcalendar.css" rel="stylesheet" type="text/css" />
        <!-- Daterange picker -->
        <link href="/css/plugins/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
        <!-- bootstrap wysihtml5 - text editor -->
        <link href="/css/plugins/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-blue">
        ...
        <script src="/js/plugins/morris.min.js" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="/js/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
        <!-- jvectormap -->
        ...
        <!-- iCheck -->
        <script src="/js/plugins/icheck.min.js" type="text/javascript"></script>
